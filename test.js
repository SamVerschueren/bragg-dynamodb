...
import * as fixture1 from './fixtures/multi-source';
import * as fixture2 from './fixtures/sns-event';
import * as fixture3 from './fixtures/event';
import m from './';
...
test('result', t => {
	...
	t.deepEqual(result.request.params, {
